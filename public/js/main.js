...
async function getGeminiResponse(userMessage) {
    try {
        const context = "You are a mental health support chatbot. Provide empathetic, supportive responses, but make it clear you're not a replacement for professional mental health care. If someone expresses serious concerns, recommend professional help.";
...
async function handleMessage(userMessage) {
    ...
    if (localResponse) {
        ...
        // Use Gemini if no local response found
